...
CREATE TABLE `groupcategory` (
  `groupcategory_id` int NOT NULL AUTO_INCREMENT,
  `groupcategory_name` varchar(255) DEFAULT NULL,
...
INSERT INTO `groupcategory` VALUES (1,'Dưỡng da'),(2,'Trang điểm'),(3,'Cơ thể & Tóc'),(4,'Công cụ & Phụ kiện'),(5,'Chăm sóc da'),(6,'Làm đẹp');
